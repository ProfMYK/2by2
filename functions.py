...
def MoveNum(cube, num):
    if num == 0:
        Move(cube, "R", amount=1)
        return "R"
    elif num == 1:
        Move(cube, "R", amount=2)
        return "R2"
    elif num == 2:
        Move(cube, "R", amount=3)
        return "R'"
    elif num == 3:
        Move(cube, "L", amount=1)
        return "L"
    elif num == 4:
        Move(cube, "L", amount=2)
        return "L2"
    elif num == 5:
        Move(cube, "L", amount=3)
        return "L'"
    elif num == 6:
        Move(cube, "U", amount=1)
        return "U"
    elif num == 7:
        Move(cube, "U", amount=2)
        return "U2"
    elif num == 8:
        Move(cube, "U", amount=3)
        return "U'"
    elif num == 9:
        Move(cube, "D", amount=1)
        return "U"
    elif num == 10:
        Move(cube, "D", amount=2)
        return "U2"
    elif num == 11:
        Move(cube, "D", amount=3)
        return "U'"
    elif num == 12:
        Move(cube, "F", amount=1)
        return "F"
    elif num == 13:
        Move(cube, "F", amount=2)
        return "F2"
    elif num == 14:
        Move(cube, "F", amount=3)
        return "F'"
    elif num == 15:
        Move(cube, "B", amount=1)
        return "B"
    elif num == 16:
        Move(cube, "B", amount=2)
        return "B2"
    elif num == 17:
        Move(cube, "B", amount=3)
        return "B'"
